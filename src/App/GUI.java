...
public class GUI extends JFrame {
    ...
    public GUI() throws IOException {
        ...
        JButton extract_max_Button = new JButton("Heap extract max");
        extract_max_Button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        JButton extract_min_Button = new JButton("Heap extract min");
        extract_min_Button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        RTC_Panel.setLayout(new FlowLayout(FlowLayout.LEFT)); // set layout to vertical
        ...
        JRadioButton folder = new JRadioButton("Type");
        ...
        radioPanel.add(file);
        radioPanel.add(folder);
        radioPanel.setMaximumSize(new Dimension(200, 35));

        // Add the row panels to RTC_Panel
        RTC_Panel.add(row1Panel);
        RTC_Panel.add(radioPanel);
        RTC_Panel.add(row2Panel);
        RTC_Panel.add(row3Panel);
        RTC_Panel.add(row4Panel);
        RTC_Panel.add(row5Panel);
        RTC_Panel.add(row6Panel);

        RTC_Panel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        /**Heap panel END*/


        ///////////////////////Main Panel///////////////////////
        buttonPanel.add(RTC_Panel, "set1");
    ...
    private void takeAllLogs() throws IOException, ParseException, InterruptedException {
        System.out.println("Take all RTC logs");

    }

    private void fromChosenFolder() throws IOException, ParseException, InterruptedException {
        System.out.println("Take logs from chosen folder");
